...
# cong dataset
#args = parser.parse_args(['id3', 'class', '--attributes', 'dataset/category/cong_attrib.txt', '--train', 'dataset/category/cong.dat', '--test', 'dataset/category/cong_test.dat'])
